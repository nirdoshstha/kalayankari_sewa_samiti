        ...
        <div class="col-lg-7">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="table-responsive">
                        ...
                        <tbody>
                            @foreach ($data['teams'] as $team)
                                <tr>
                                    ...
                                    <td>{{ $team->title }}</td>
                                    <td><img src="{{asset('storage/'.$team->image)}}" class="img-thumbnail" width="50" /></td>
                                     
                                    <td class="d-sm-flex align-items-center py-4">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#view-{{ $team->id }}"><i
                                                class="fa fa-eye fs-17 px-3 text-info"></i></a>
                                        <a href="#" data-bs-toggle="modal"
                                        data-bs-target="#edit-{{ $team->id }}"><i
                                            class="fa fa-edit fs-17 px-3 text-info"></i></a>
                                        
                                            <div class="main-toggle-group d-sm-flex align-items-center"> 
                                                <div class="toggle show_hide toggle-md toggle-{{ $team->status == '0' ? 'success' : ''}} my-1 {{ $team->status == '0' ? 'on' : 'off' }}" data-id="{{$team->id}}">
                                                     <span></span>
                                                </div>
                                            </div>
                                             
                                            
                                                <form action="{{ route($base_route . 'destroy', $team->id) }}"
                                                    method="POST" class="main_form" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('DELETE')
                                            <a href="#" ><i class="fa fa-trash fs-17 px-3 text-danger delete-confirm" data-id="{{$team->id}}"></i></a>
                                                </form>
                 ...
                 {{-- //View Modal Details --}}
                 @foreach ($data['teams'] as $team)
                 <div class="modal fade" id="view-{{ $team->id }}" tabindex="-1"
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-md-8">
                                                @if (isset($team->image))
                                                     <img src="{{ image_path($team->image) }}" width="80"
                                                         class="img-thumbnail">
                                                 @else
                                    ...
                                    <hr> 
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                     <p>{{$team->createdBy?->name}} ({{$team->created_at->format('Y-m-d')}})</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                     <p>{{$team->updatedBy?->name}} ({{$team->updated_at->format('Y-m-d')}})</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal fade" id="edit-{{ $team->id }}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body"> 
                                <form action="{{ route($base_route.'update',$team->id) }}" method="POST" class="row g-3 main_form" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <input type="hidden" name="type" value="post"> 
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="title" class="form-control title" value="{{isset($team) ? $team->title : ''}}" id="floatingName" placeholder="Album Name">
                                            <label for="floatingName">Title</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title" class="form-control title" value="{{isset($team) ? $team->sub_title : ''}}" id="floatingName" placeholder="Album Name">
                                        ...
                                        <label for="" class="form-label">Image</label>
                                            <div class="form-group">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <img src="{{asset('storage/'.$team->image)}}" width="50" class="img-thumbnail">  
                                                    @else
                                                    <input name="image" class="form-control p-4" type="file"><span class="p-2"></span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="rank" class="form-control title" value="{{isset($team) ? $team->rank : ''}}" id="floatingName" placeholder="Album Name">
                                            <label for="floatingName">Rank</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <textarea name="description" class="form-control" style="height: 100px;">{{isset($team) ? $team->description : ''}}</textarea>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                         {{isset($data['team']) ? 'Update' : 'Create' }} Page {{$panel ?? ''}}</h5>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body tabs-menu-body">
                            @if(isset($data['team']))
                            <form action="{{ route($base_route.'update',$data['team']->id) }}" method="POST" class="row g-3 main_form">
                            @csrf
                            @method('PUT') 
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1"> 
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title" value="{{ isset($data['team']) ? $data['team']->title : old('title')}}" class="form-control" id="title"
                                                placeholder="Title">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title" value="{{ isset($data['team']) ? $data['team']->sub_title : old('sub_title')}}" class="form-control"   
                                                placeholder="Subtitle">
                                           
                                            <label for="floatingUser">Designation</label>
                                        </div>
                                    </div> 
                                        ...
                                        <div class="form-group">                     
                                            <div class="image dropify-wrapper">
                                                @if(!empty($data['team']->image))
                                                    <img src="{{ asset('storage/' . $data['team']->image) }}" alt=""
                                                        class="previewImage">
                                                @else
                                ...
                                <div class="tab-pane mb-3" id="tab2">
                                           ...
                                           <textarea name="description" class="form-control"  id="summernote" style="height: 290px;">{{isset($data['team']) ? $data['team']->description : old('description')}}</textarea>
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title" value="{{ isset($data['team']) ? $data['team']->seo_title : ''}}" class="form-control" id="floatingName"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword" value="{{ isset($data['team']) ? $data['team']->seo_keyword : ''}}" class="form-control"   
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <textarea  name="seo_description" value="" class="form-control"   
                                                placeholder="Seo Description">{{ isset($data['team']) ? $data['team']->seo_description : ''}}</textarea>
