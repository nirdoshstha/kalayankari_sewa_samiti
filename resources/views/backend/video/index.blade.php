                                    ...
                                    <tr>
                                        ...
                                        <td class="d-sm-flex align-items-center">
                                            ...
                                            <div class="main-toggle-group d-sm-flex align-items-center">
                                                <div class="toggle show_hide toggle-md toggle-{{ $video->status == '0' ? 'success' : '' }} my-1 {{ $video->status == '0' ? 'on' : 'off' }}"
                                                    data-id="{{ $video->id }}">
                                                    <span></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                    <p>{{ $video->updatedBy?->name }}
                                                        ({{ $video->updated_at->format('Y-m-d') }})</p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal fade" id="edit-{{ $video->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route($base_route . 'update', $video->id) }}" method="POST"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-floating">
                                                <input type="text" name="title" class="form-control title"
                                                    value="{{ isset($video) ? $video->title : '' }}" id="floatingName"
                                        ...
                                        {{-- <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" name="sub_title" class="form-control title"
                                                    value="{{ isset($video) ? $video->sub_title : '' }}"
                                            ...
                                            <div class="form-group">
                                                <div class="d-flex justify-content-between">
                                                    @if (isset($video->image))
                                                        ...
                                                        <span class="p-2"></span>
                                                        <img src="{{ asset('storage/' . $video->image) }}" width="50"
                                                            class="img-thumbnail">
                                                    @else
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" name="video_link" class="form-control title"
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                        {{ isset($data['video']) ? 'Update' : 'Create' }} Page {{ $panel ?? '' }}
                    </h5>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body tabs-menu-body">
                            @if (isset($data['video']))
                                <form action="{{ route($base_route . 'update', $data['video']->id) }}" method="POST"
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title"
                                                value="{{ isset($data['video']) ? $data['video']->title : old('title') }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title"
                                                value="{{ isset($data['video']) ? $data['video']->sub_title : old('sub_title') }}"
                                        ...
                                        <div class="form-group">
                                            <div class="image dropify-wrapper">
                                                @if (!empty($data['video']->image))
                                                    <img src="{{ asset('storage/' . $data['video']->image) }}"
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title"
                                                value="{{ isset($data['video']) ? $data['video']->seo_title : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword"
                                                value="{{ isset($data['video']) ? $data['video']->seo_keyword : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <textarea name="seo_description" value="" class="form-control" placeholder="Seo Description">{{ isset($data['video']) ? $data['video']->seo_description : '' }}</textarea>
