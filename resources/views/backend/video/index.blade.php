        ...
        <div class="col-lg-7">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="table-responsive">
                    <table id="user-datatable" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 25%">Video Link</th> 
                                ...
                                <tr>
                                    ...
                                    <td class="d-sm-flex align-items-center">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#view-{{ $video->id }}"><i
                                                class="fa fa-eye fs-17 px-3 text-info"></i></a>
                                        <a href="#" data-bs-toggle="modal"
                                        data-bs-target="#edit-{{ $video->id }}"><i
                                            class="fa fa-edit fs-17 px-3 text-info"></i></a>
                                        
                                            <div class="main-toggle-group d-sm-flex align-items-center"> 
                                                <div class="toggle show_hide toggle-md toggle-{{ $video->status == '0' ? 'success' : ''}} my-1 {{ $video->status == '0' ? 'on' : 'off' }}" data-id="{{$video->id}}">
                                                     <span></span>
                                                </div>
                                            </div>
                                                ...
                                                <form action="{{ route($base_route . 'destroy', $video->id) }}"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                            <a href="#" ><i class="fa fa-trash fs-17 px-3 text-danger delete-confirm" data-id="{{$video->id}}"></i></a>
                                                </form>
                 ...
                 {{-- //View Modal Details --}}
                 @foreach ($data['videos'] as $video)
                 <div class="modal fade" id="view-{{ $video->id }}" tabindex="-1"
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row row-sm">
                                            <div class="col-md-4">
                                                <label for="email" class="form-label">Video Title</label>
                                            </div>
                                            <div class="col-md-8">
                                                <p>{{$video->title}}</p>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row row-sm">
                                            <div class="col-md-4">
                                                <label for="email" class="form-label">Video Subtitle</label>
                                            </div>
                                            <div class="col-md-8">
                                                <p>{{$video->sub_title}}</p>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row row-sm">
                                            <div class="col-md-4">
                                                <label for="email" class="form-label">Video Cover</label>
                                            </div>
                                            <div class="col-md-8">
                                                @if (isset($video->image))
                                                     <img src="{{ image_path($video->image) }}" width="80"
                                                         class="img-thumbnail">
                                                 @else
                                    ...
                                    <hr> 
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                     <p>{{$video->createdBy?->name}} ({{$video->created_at->format('Y-m-d')}})</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                     <p>{{$video->updatedBy?->name}} ({{$video->updated_at->format('Y-m-d')}})</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal fade" id="edit-{{ $video->id }}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body"> 
                                <form action="{{ route($base_route.'update',$video->id) }}" method="POST" class="row g-3 main_form" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <input type="hidden" name="type" value="post"> 
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="title" class="form-control title" value="{{isset($video) ? $video->title : ''}}" id="floatingName" placeholder="Album Name">
                                            <label for="floatingName">Video Title</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title" class="form-control title" value="{{isset($video) ? $video->sub_title : ''}}" id="floatingName" placeholder="Album Name">
                                        ...
                                        <label for="" class="form-label">Image</label>
                                            <div class="form-group">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <img src="{{asset('storage/'.$video->image)}}" width="50" class="img-thumbnail">  
                                                    @else
                                                    <input name="image" class="form-control p-4" type="file"><span class="p-2"></span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="video_link" class="form-control title" value="{{isset($video) ? $video->video_link : ''}}" id="floatingName" placeholder="Album Name">
                                            <label for="floatingName">Video Link</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <textarea name="description" class="form-control" style="height: 100px;">{{isset($video) ? $video->description : ''}}</textarea>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                         {{isset($data['video']) ? 'Update' : 'Create' }} Page {{$panel ?? ''}}</h5>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body tabs-menu-body">
                            @if(isset($data['video']))
                            <form action="{{ route($base_route.'update',$data['video']->id) }}" method="POST" class="row g-3 main_form">
                            @csrf
                            @method('PUT') 
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1"> 
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title" value="{{ isset($data['video']) ? $data['video']->title : old('title')}}" class="form-control" id="title"
                                                placeholder="Title">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title" value="{{ isset($data['video']) ? $data['video']->sub_title : old('sub_title')}}" class="form-control"   
                                        ...
                                        <div class="form-group">                     
                                            <div class="image dropify-wrapper">
                                                @if(!empty($data['video']->image))
                                                    <img src="{{ asset('storage/' . $data['video']->image) }}" alt=""
                                                        class="previewImage">
                                                @else
                                ...
                                <div class="tab-pane mb-3" id="tab2">
                                           ...
                                           <textarea name="description" class="form-control"  id="summernote" style="height: 290px;">{{isset($data['video']) ? $data['video']->description : old('description')}}</textarea>
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title" value="{{ isset($data['video']) ? $data['video']->seo_title : ''}}" class="form-control" id="floatingName"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword" value="{{ isset($data['video']) ? $data['video']->seo_keyword : ''}}" class="form-control"   
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <textarea  name="seo_description" value="" class="form-control"   
                                                placeholder="Seo Description">{{ isset($data['video']) ? $data['video']->seo_description : ''}}</textarea>
				...
				<div class="modal-content">
					...
					<div class="modal-body"> 
                            <form action="{{ route($base_route.'store') }}" method="POST" class="row g-3 main_form" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" name="video_link" class="form-control title" value="" id="floatingName" placeholder="Album Name">
                                        <label for="floatingName">Video Link</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
