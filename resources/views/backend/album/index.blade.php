                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($albums->image)
                                                <img src="{{ asset('storage/' . $albums->image) }}"
                                                    class="img-thumbnail p-0 m-0" width="auto">
                                            @else
                                        ...
                                        <td class="d-flex align-items-center text-center border-0">
                                            ...
                                            <div class="main-toggle-group d-sm-flex align-items-center">
                                                <div class="toggle show_hide toggle-md toggle-{{ $albums->status == '0' ? 'success' : '' }} my-1 {{ $albums->status == '0' ? 'on' : 'off' }}"
                                                    data-id="{{ $albums->id }}">
                                                    <span></span>
                                                </div>
                                            </div>
                                            ...
                                            <form action="{{ route($base_route . 'destroy', $albums->id) }}" method="POST"
                                                class="main_form" enctype="multipart/form-data">
                                                @csrf
                                                @method('DELETE')
                                                <a href="#">
                                                    <i class="fa fa-trash fs-17 px-3 text-danger delete-confirm"></i>
                                                </a>
                                            </form>
                                        ...
                                        <form class="row g-3">
                                            <div class="col-md-12">
                                                <button type="button" class="btn btn-outline-success mt-1 mb-1 me-3">
                                                    <span>Images</span>
                                                    <span
                                                        class="badge bg-success rounded-pill">{{ $album->images->count() }}</span>
                                                </button>
                                            </div>
                                            <div class="row p-3">
                                                <div class="col-md-12 d-flex align-content-start flex-wrap">
                                                    @isset($album->images)
                                                        @foreach ($album->images as $image)
                                                            <div class="image p-2">
                                                                <img src="{{ image_path($image->url) }}" alt=""
                                                                    height="50px">
                                                            </div>
                                                            <div class="icon ">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                        {{ isset($data['album']) ? 'Update' : 'Create' }} Page {{ $panel ?? '' }}
                    </h5>
                        ...
                        <div class="panel-body tabs-menu-body">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title"
                                                value="{{ isset($data['album']) ? $data['album']->title : old('title') }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title"
                                                value="{{ isset($data['album']) ? $data['album']->sub_title : old('sub_title') }}"
                                        ...
                                        <div class="form-group">
                                            <div class="image dropify-wrapper">
                                                @if (!empty($data['album']->image))
                                                    <img src="{{ asset('storage/' . $data['album']->image) }}"
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title"
                                                value="{{ isset($data['album']) ? $data['album']->seo_title : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword"
                                                value="{{ isset($data['album']) ? $data['album']->seo_keyword : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <textarea name="seo_description" value="" class="form-control" placeholder="Seo Description">{{ isset($data['album']) ? $data['album']->seo_description : '' }}</textarea>
