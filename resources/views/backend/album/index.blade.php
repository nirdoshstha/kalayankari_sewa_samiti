        ...
        <div class="col-lg-7">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="table-responsive">
                        ...
                        <tbody>
                            @foreach ($data['albums'] as $albums)
                                <tr>
                                    ...
                                    <td>
                                        @if($albums->image)
                                        <img src="{{asset('storage/'.$albums->image)}}" class="img-thumbnail p-0 m-0" width="auto">
                                        @else
                                        <img src="{{asset('dummy_image.jpg')}}" class="img-thumbnail p-0 m-0" width="auto">
                                        @endif
                                    </td>
                                    <td class="text-center">{{$albums->images()->count()}}</td>
                                     
                                    <td class="d-flex align-items-center text-center border-0">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#view-{{ $albums->id }}"><i
                                        ...
                                        <a href="{{route($base_route.'edit',$albums->id)}}"><i
                                            ...
                                            <div class="main-toggle-group d-sm-flex align-items-center"> 
                                                <div class="toggle show_hide toggle-md toggle-{{ $albums->status == '0' ? 'success' : ''}} my-1 {{ $albums->status == '0' ? 'on' : 'off' }}" data-id="{{$albums->id}}">
                                                     <span></span>
                                                </div>
                                            </div>
                                                ...
                                                <form action="{{ route($base_route . 'destroy', $albums->id) }}"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                            <a href="#" ><i class="fa fa-trash fs-17 px-3 text-danger delete-confirm" data-id="{{$albums->id}}"></i></a>
                                                </form>
                 ...
                 <div class="modal fade" id="view-{{ $album->id }}" tabindex="-1"
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row row-sm">
                                            <div class="col-md-4">
                                                <label for="email" class="form-label">Album Name</label>
                                            </div>
                                            <div class="col-md-8">
                                                <p>{{$album->title}}</p>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row row-sm">
                                            <div class="col-md-4">
                                                <label for="email" class="form-label">Album Cover</label>
                                            </div>
                                            <div class="col-md-8">
                                                @if (isset($album->image))
                                                     <img src="{{ image_path($album->image) }}" width="80"
                                                         class="img-thumbnail">
                                                 @else
                                     ...
                                     <form class="row g-3"> 
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-outline-success mt-1 mb-1 me-3">
                                                <span>Images</span>
                                                <span class="badge bg-success rounded-pill">{{$album->images->count()}}</span>
                                            </button>
                                        </div>
                                         <div class="row p-3">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                         {{isset($data['album']) ? 'Update' : 'Create' }} Page {{$panel ?? ''}}</h5>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body tabs-menu-body">
                            @if(isset($data['album']))
                            <form action="{{ route($base_route.'update',$data['album']->id) }}" method="POST" class="row g-3 main_form">
                            @csrf
                            @method('PUT') 
                        ...
                        @endif 
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1"> 
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title" value="{{ isset($data['album']) ? $data['album']->title : old('title')}}" class="form-control" id="title"
                                                placeholder="Title">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title" value="{{ isset($data['album']) ? $data['album']->sub_title : old('sub_title')}}" class="form-control"   
                                        ...
                                        <div class="form-group">                     
                                            <div class="image dropify-wrapper">
                                                @if(!empty($data['album']->image))
                                                    <img src="{{ asset('storage/' . $data['album']->image) }}" alt=""
                                                        class="previewImage">
                                                @else
                                ...
                                <div class="tab-pane mb-3" id="tab2">
                                           ...
                                           <textarea name="description" class="form-control"  id="summernote" style="height: 290px;">{{isset($data['album']) ? $data['album']->description : old('description')}}</textarea>
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title" value="{{ isset($data['album']) ? $data['album']->seo_title : ''}}" class="form-control" id="floatingName"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword" value="{{ isset($data['album']) ? $data['album']->seo_keyword : ''}}" class="form-control"   
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <textarea  name="seo_description" value="" class="form-control"   
                                                placeholder="Seo Description">{{ isset($data['album']) ? $data['album']->seo_description : ''}}</textarea>
