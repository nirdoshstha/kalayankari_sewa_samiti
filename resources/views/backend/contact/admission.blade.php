...
@section('content')
    <div class="col-lg-12">
        <div class="card recent-sales overflow-auto">
                                ...
                                <tr>
                                    ...
                                    <td class="d-sm-flex align-items-center py-2">
                                        ...
                                        <form action="{{ route('admission.delete', $admission->id) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <a href="#"><i class="fa fa-trash fs-17 px-3 text-danger delete-confirm"
                                                    data-id="{{ $admission->id }}"></i></a>
                                        </form>
            ...
            {{-- //View Modal Details --}}
            @foreach ($data['admissions'] as $admission)
                <div class="modal fade" id="view-{{ $admission->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                                ...
                                <div class="card">
                                    <div class="card-body p-5">
                                        ...
                                        <div class="mb-2">
                                            <label for="text-form" class="form-label mb-0">Name of the Applicant (Full Name)
                                                <input type="text" name="name" value="{{ $admission->name ?? '' }}"
                                                    class="form-control" id="text-form" aria-describedby="emailHelp"
                                                    readonly>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    <label for="select-form1" class="form-label mb-0">Applied for Grade
                                                        <span class="text-danger">*</span></label>

                                                    <input value="{{ $admission->grade ?? '' }}" class="form-control"
                                                        readonly>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->current_grade ?? '' }}" readonly>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-sm-4">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->gender ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->nationality ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->email ?? '' }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row align-items-center">
                                            <div class="col-sm-4">
                                                <div class="mb-2">
                                                    <label for="date-form1" class="form-label mb-0">Date of
                                                        birth(BS):</label>
                                                    <div class="icon-Wrapper">
                                                        <input type="text" class="form-control"
                                                            value="{{ $admission->dob_bs ?? '' }}" readonly>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mb-2">
                                                    <label for="date-form22" class="form-label mb-0">Date of
                                                        birth(AD):</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->dob_ad ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-2">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    <label for="text-form6" class="form-label mb-0">Address <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->address ?? '' }}" readonly>
                                                    <span class="text-danger">
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    <label for="text-form7" class="form-label mb-0">Phone <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->phone ?? '' }}" readonly>
                                                    <span class="text-danger">
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    <label for="text-form8" class="form-label mb-0">Father's Name <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->father_name ?? '' }}" readonly>
                                                    <span class="text-danger">
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->father_mobile ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->father_email ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->father_occupation ?? '' }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-header mb-2">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    <label for="text-form13" class="form-label mb-0">Mother's Name <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->mother_name ?? '' }}" readonly>
                                                    <span class="text-danger">
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->mother_mobile ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->mother_email ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->mother_occupation ?? '' }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-header mb-2">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    <label for="text-form17" class="form-label mb-0">Local
                                                        Guardian:</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->guardian ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->guardian_mobile ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->guardian_email ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->guardian_occupation ?? '' }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-header mb-2">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-4">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->previous_school_name ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->previous_school_address ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $admission->previous_school_grade ?? '' }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
