                        ...
                        @else
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="phone" class="form-control" id="phoneNumber"
                                            placeholder="+97714310000"
                                            value="{{ $setting ? $setting->phone : old('phone') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="mobile" class="form-control" id="website"
                                            placeholder="+9779801000000"
                            ...
                            <div class="form-group ">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="address" id="address" name="example-textarea-input" rows="2"
                                            placeholder="San Francisco, CA">{{ $setting ? $setting->address : old('address') }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="facebook" class="form-control" id="facebook"
                                            ...
                                            value="{{ $setting ? $setting->facebook : old('facebook') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="twitter" class="form-control" id="twitter"
                                            placeholder="twitter.com/abc"
                                            value="{{ $setting ? $setting->twitter : old('twitter') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="youtube" class="form-control" id="youtube"
                                            placeholder="youtube.com/abc"
                                            value="{{ $setting ? $setting->youtube : old('youtube') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="linkedin" class="form-control" id="linkedin"
                                            placeholder="linkedin.com/abc"
                                            value="{{ $setting ? $setting->linkedin : old('linkedin') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="instagram" class="form-control" id="instagram"
                                            ...
                                            value="{{ $setting ? $setting->instagram : old('instagram') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="viber" class="form-control" id="viber"
                                            placeholder="+977980100000"
                                            value="{{ $setting ? $setting->viber : old('viber') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="whatsapp" class="form-control" id="viber"
                                            placeholder="whatsapp"
                                            value="{{ $setting ? $setting->whatsapp : old('whatsapp') }}">
                                    </div>
                                </div>
                            </div>
                            {{-- <div class="form-group ">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <div class="col-sm-12 col-md-12 col-lg-12 image">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="logo"
                                                    class="form-control file-input custom-file-input mt-3" type="file"
                                                    id="formFile">
                                            ...
                                            <div class="form-group">
                                                <div class="image dropify-wrapper">
                                                    @if (!empty($setting->image))
                                                        ...
                                                        @isset($setting->image)
                                                            @if ($extension == 'pdf')
                                                                <a href="{{ asset('storage/' . $setting->image) }}"
                                                                    target="_blank">
                                                            ...
                                                            @else
                                                                <a href="{{ asset('storage/' . $setting->image) }}"
                                                                    target="_blank">
                                                                    <img src="{{ asset('storage/' . $setting->image) }}"
                                                                        alt="" class="previewImage" height="200px">
                                                                </a>
                                                            @endif
                                                        @endisset
                                                    @else
