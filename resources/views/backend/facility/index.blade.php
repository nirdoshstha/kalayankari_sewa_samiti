                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center text-center border-0">
                                            ...
                                            <div class="main-toggle-group d-sm-flex align-items-center">
                                                <div class="toggle show_hide toggle-md toggle-{{ $facility->status == '0' ? 'success' : '' }} my-1 {{ $facility->status == '0' ? 'on' : 'off' }}"
                                                    data-id="{{ $facility->id }}">
                                                    <span></span>
                                                </div>
                                            </div>
                                            ...
                                            <form action="{{ route($base_route . 'destroy', $facility->id) }}"
                                                ...
                                                @method('DELETE')
                                                <a href="#"><i
                                                        class="fa fa-trash fs-17 px-3 my-4 text-danger delete-confirm"
                                                        data-id="{{ $facility->id }}"></i></a>
                                            </form>
                                        ...
                                        <form class="row g-3">
                                            <div class="col-md-12">
                                                <button type="button" class="btn btn-outline-success mt-1 mb-1 me-3">
                                                    <span>Images</span>
                                                    <span
                                                        class="badge bg-success rounded-pill">{{ $facility->images->count() }}</span>
                                                </button>
                                            </div>
                                            <div class="row p-3">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                        {{ isset($data['facility']) ? 'Update' : 'Create' }} Page {{ $panel ?? '' }}
                    </h5>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title"
                                                value="{{ isset($data['facility']) ? $data['facility']->title : old('title') }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title"
                                                value="{{ isset($data['facility']) ? $data['facility']->sub_title : old('sub_title') }}"
                                        ...
                                        <div class="form-group">
                                            <div class="image dropify-wrapper">
                                                @if (!empty($data['facility']->image))
                                                    <img src="{{ asset('storage/' . $data['facility']->image) }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title"
                                                value="{{ isset($data['facility']) ? $data['facility']->seo_title : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword"
                                                value="{{ isset($data['facility']) ? $data['facility']->seo_keyword : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input name="seo_description"
                                                value="{{ isset($data['facility']) ? $data['facility']->seo_description : '' }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route($base_route . 'store') }}" method="POST" class="row g-3 main_form"
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="title" class="form-control title" value=""
                                        id="floatingName" placeholder="Facility Name">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea name="description" id="editor2" class="form-control" placeholder="Description"> </textarea>
                                    <label for="floatingName">Description</label>
                                </div>
                            </div>
