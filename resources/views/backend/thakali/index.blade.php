    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card recent-sales overflow-auto">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="user-datatable" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($data['thakalis'] as $thakali)
                                    <tr>
                                        <th scope="row">{{ $loop->iteration }}</th>
                                        <td>{{ $thakali->title }}</td>
                                        <td><img src="{{ asset('storage/' . $thakali->image) }}" class="img-fluid"
                                                width="40" /></td>
                                        <td>
                                            <div class="main-toggle-group d-sm-flex align-items-center">
                                                <div class="toggle show_hide toggle-md toggle-{{ $thakali->status == '1' ? 'success' : '' }} my-1 {{ $thakali->status == '1' ? 'on' : 'off' }}"
                                                    data-id="{{ $thakali->id }}">
                                                    <span></span>
                                                </div>
                                            </div>
                ...
                {{-- //View Modal Details --}}
                @foreach ($data['thakalis'] as $thakali)
                    <div class="modal fade" id="view-{{ $thakali->id }}" tabindex="-1"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                    @if (isset($thakali->image))
                                                        <img src="{{ image_path($thakali->image) }}" width="80"
                                                            class="img-thumbnail">
                                                    @else
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                    <p>{{ $thakali->createdBy?->name }}
                                                        ({{ $thakali->created_at->format('Y-m-d') }})
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                    <p>{{ $thakali->updatedBy?->name }}
                                                        ({{ $thakali->updated_at->format('Y-m-d') }})</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                {{-- //Edit thakali Modal Details --}}
                @foreach ($data['thakalis'] as $thakali)
                    <div class="modal fade" id="edit-{{ $thakali->id }}" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route($base_route . 'update', $thakali->id) }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" name="title" class="form-control title"
                                                    value="{{ isset($thakali) ? $thakali->title : '' }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="date" name="start_date" class="form-control title"
                                                    value="{{ isset($thakali) ? $thakali->start_date : '' }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="date" name="end_date" class="form-control title"
                                                    value="{{ isset($thakali) ? $thakali->end_date : '' }}"
                                                    id="floatingName" placeholder="Sub Title">
                                            ...
                                            <div class="form-group">
                                                <div class="d-flex justify-content-between">
                                                    @if (isset($thakali->image))
                                                        ...
                                                        <span class="p-2"></span>
                                                        <img src="{{ asset('storage/' . $thakali->image) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" name="rank" class="form-control title"
                                                    value="{{ isset($thakali) ? $thakali->rank : '' }}" id="floatingName"
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                        {{ isset($data['thakali']) ? 'Update' : 'Create' }} Page {{ $panel ?? '' }}
                    </h5>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body tabs-menu-body">
                            @if (isset($data['thakali']))
                                <form action="{{ route($base_route . 'update', $data['thakali']->id) }}" method="POST"
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title"
                                                value="{{ isset($data['thakali']) ? $data['thakali']->title : old('title') }}"
                                    ...
                                    {{-- <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title"
                                                value="{{ isset($data['thakali']) ? $data['thakali']->sub_title : old('sub_title') }}"
                                    ...
                                    <div class="col-md-12 mb-3 image">
                                        ...
                                        <div class="form-group">
                                            <div class="image dropify-wrapper">
                                                @if (!empty($data['thakali']->image))
                                                    <img src="{{ asset('storage/' . $data['thakali']->image) }}"
                                ...
                                <div class="tab-pane mb-3" id="tab2">
                                    ...
                                    <textarea name="description" class="form-control" id="summernote" style="height: 290px;">{{ isset($data['thakali']) ? $data['thakali']->description : old('description') }}</textarea>
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title"
                                                value="{{ isset($data['thakali']) ? $data['thakali']->seo_title : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword"
                                                value="{{ isset($data['thakali']) ? $data['thakali']->seo_keyword : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <textarea name="seo_description" value="" class="form-control" placeholder="Seo Description">{{ isset($data['thakali']) ? $data['thakali']->seo_description : '' }}</textarea>
