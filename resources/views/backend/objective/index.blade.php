    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="card recent-sales overflow-auto">
                            ...
                            <tbody>
                                @foreach ($data['objectives'] as $objective)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('storage/' . $objective->image) }}" class="img-thumbnail"
                                                width="50" /></td>

                                        <td class="d-sm-flex align-items-center py-4">
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#view-{{ $objective->id }}"><i
                                                    class="fa fa-eye fs-17 px-3 text-info"></i></a>
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#edit-{{ $objective->id }}"><i
                                                    class="fa fa-edit fs-17 px-3 text-info"></i></a>

                                            <div class="main-toggle-group d-sm-flex align-items-center">
                                                <div class="toggle show_hide toggle-md toggle-{{ $objective->status == '0' ? 'success' : '' }} my-1 {{ $objective->status == '0' ? 'on' : 'off' }}"
                ...
                {{-- //View Modal Details --}}
                @foreach ($data['objectives'] as $objective)
                    <div class="modal fade" id="view-{{ $objective->id }}" tabindex="-1"
                    ...
                    <div class="form-group">
                        <div class="row row-sm">
                            ...
                            <div class="col-md-8">
                                @if (isset($objective->image))
                                    <img src="{{ image_path($objective->image) }}" width="80" class="img-thumbnail">
                                @else
                    ...
                    <div class="form-group">
                        <div class="row row-sm">
                            ...
                            <div class="col-md-8">
                                <p>{{ $objective->createdBy?->name }} ({{ $objective->created_at->format('Y-m-d') }})</p>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row row-sm">
                            ...
                            <div class="col-md-8">
                                <p>{{ $objective->updatedBy?->name }} ({{ $objective->updated_at->format('Y-m-d') }})</p>
                            </div>
                        </div>
                    </div>
        ...
        {{-- //Edit objective Modal Details --}}
        @foreach ($data['objectives'] as $objective)
            <div class="modal fade" id="edit-{{ $objective->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route($base_route . 'update', $objective->id) }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" name="title" class="form-control title"
                                            value="{{ isset($objective) ? $objective->title : '' }}" id="floatingName"
                                        ...
                                        <div class="d-flex justify-content-between">
                                            @if (isset($objective->image))
                                                <input name="image" class="form-control p-4" type="file"> <span
                                                    class="p-2"></span>
                                                <img src="{{ asset('storage/' . $objective->image) }}" width="50"
                                                    class="img-thumbnail">
                                            @else
                                                <input name="image" class="form-control p-4" type="file"><span
                                                    class="p-2"></span>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                        {{ isset($data['objective']) ? 'Update' : 'Create' }} Page {{ $panel ?? '' }}
                    </h5>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body tabs-menu-body">
                            @if (isset($data['objective']))
                                <form action="{{ route($base_route . 'update', $data['objective']->id) }}" method="POST"
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title"
                                                value="{{ isset($data['objective']) ? $data['objective']->title : old('title') }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title"
                                                value="{{ isset($data['objective']) ? $data['objective']->sub_title : old('sub_title') }}"
                                    ...
                                    <div class="col-md-12 mb-3 image">
                                        ...
                                        <div class="form-group">
                                            <div class="image dropify-wrapper">
                                                @if (!empty($data['objective']->image))
                                                    <img src="{{ asset('storage/' . $data['objective']->image) }}"
                                ...
                                <div class="tab-pane mb-3" id="tab2">
                                    ...
                                    <textarea name="description" class="form-control" id="summernote" style="height: 290px;">{{ isset($data['objective']) ? $data['objective']->description : old('description') }}</textarea>
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title"
                                                value="{{ isset($data['objective']) ? $data['objective']->seo_title : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword"
                                                value="{{ isset($data['objective']) ? $data['objective']->seo_keyword : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <textarea name="seo_description" value="" class="form-control" placeholder="Seo Description">{{ isset($data['objective']) ? $data['objective']->seo_description : '' }}</textarea>
