    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card recent-sales overflow-auto">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="user-datatable" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($data['chairpersons'] as $chairperson)
                                    <tr>
                                        <th scope="row">{{ $loop->iteration }}</th>
                                        <td>{{ $chairperson->title }}</td>
                                        <td><img src="{{ asset('storage/' . $chairperson->image) }}" class="img-thumbnail"
                                                width="50" /></td>
                                        <td>
                                            <div class="main-toggle-group d-sm-flex align-items-center">
                                                <div class="toggle show_hide toggle-md toggle-{{ $chairperson->status == '1' ? 'success' : '' }} my-1 {{ $chairperson->status == '1' ? 'on' : 'off' }}"
                                                    data-id="{{ $chairperson->id }}">
                                                    <span></span>
                                                </div>
                                            </div>
                                        </td>
                ...
                {{-- //View Modal Details --}}
                @foreach ($data['chairpersons'] as $chairperson)
                    <div class="modal fade" id="view-{{ $chairperson->id }}" tabindex="-1"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                    @if (isset($chairperson->image))
                                                        <img src="{{ image_path($chairperson->image) }}" width="80"
                                                            class="img-thumbnail">
                                                    @else
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                    <p>{{ $chairperson->createdBy?->name }}
                                                        ({{ $chairperson->created_at->format('Y-m-d') }})
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                    <p>{{ $chairperson->updatedBy?->name }}
                                                        ({{ $chairperson->updated_at->format('Y-m-d') }})</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                {{-- //Edit chairperson Modal Details --}}
                @foreach ($data['chairpersons'] as $chairperson)
                    <div class="modal fade" id="edit-{{ $chairperson->id }}" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route($base_route . 'update', $chairperson->id) }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" name="title" class="form-control title"
                                                    value="{{ isset($chairperson) ? $chairperson->title : '' }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="date" name="start_date" class="form-control title"
                                                    value="{{ isset($chairperson) ? $chairperson->start_date : '' }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="date" name="end_date" class="form-control title"
                                                    value="{{ isset($chairperson) ? $chairperson->end_date : '' }}"
                                                    id="floatingName" placeholder="Sub Title">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                        {{ isset($data['chairperson']) ? 'Update' : 'Create' }} Page {{ $panel ?? '' }}
                    </h5>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body tabs-menu-body">
                            @if (isset($data['chairperson']))
                                <form action="{{ route($base_route . 'update', $data['chairperson']->id) }}"
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title"
                                                value="{{ isset($data['chairperson']) ? $data['chairperson']->title : old('title') }}"
                                    ...
                                    {{-- <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title"
                                                value="{{ isset($data['chairperson']) ? $data['chairperson']->sub_title : old('sub_title') }}"
                                    ...
                                    <div class="col-md-12 mb-3 image">
                                        ...
                                        <div class="form-group">
                                            <div class="image dropify-wrapper">
                                                @if (!empty($data['chairperson']->image))
                                                    <img src="{{ asset('storage/' . $data['chairperson']->image) }}"
                                ...
                                <div class="tab-pane mb-3" id="tab2">
                                    ...
                                    <textarea name="description" class="form-control" id="summernote" style="height: 290px;">{{ isset($data['chairperson']) ? $data['chairperson']->description : old('description') }}</textarea>
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title"
                                                value="{{ isset($data['chairperson']) ? $data['chairperson']->seo_title : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword"
                                                value="{{ isset($data['chairperson']) ? $data['chairperson']->seo_keyword : '' }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <textarea name="seo_description" value="" class="form-control" placeholder="Seo Description">{{ isset($data['chairperson']) ? $data['chairperson']->seo_description : '' }}</textarea>
