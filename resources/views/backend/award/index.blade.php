        ...
        <div class="col-lg-7">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="table-responsive">
                        ...
                        <tbody>
                            @foreach ($data['awards'] as $award)
                                <tr>
                                    ...
                                    <td>{{ $award->title }}</td>
                                    <td><img src="{{asset('storage/'.$award->image)}}" class="img-thumbnail" width="50" /></td>
                                     
                                    <td class="d-sm-flex align-items-center py-4">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#view-{{ $award->id }}"><i
                                                class="fa fa-eye fs-17 px-3 text-info"></i></a>
                                        <a href="#" data-bs-toggle="modal"
                                        data-bs-target="#edit-{{ $award->id }}"><i
                                            class="fa fa-edit fs-17 px-3 text-info"></i></a>
                                        
                                            <div class="main-toggle-group d-sm-flex align-items-center"> 
                                                <div class="toggle show_hide toggle-md toggle-{{ $award->status == '0' ? 'success' : ''}} my-1 {{ $award->status == '0' ? 'on' : 'off' }}" data-id="{{$award->id}}">
                                                     <span></span>
                                                </div>
                                            </div>
                                             
                                            
                                                <form action="{{ route($base_route . 'destroy', $award->id) }}"
                                                    method="POST" class="main_form" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('DELETE')
                                            <a href="#" ><i class="fa fa-trash fs-17 px-3 text-danger delete-confirm" data-id="{{$award->id}}"></i></a>
                                                </form>
                 ...
                 {{-- //View Modal Details --}}
                 @foreach ($data['awards'] as $award)
                 <div class="modal fade" id="view-{{ $award->id }}" tabindex="-1"
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-md-8">
                                                @if (isset($award->image))
                                                     <img src="{{ image_path($award->image) }}" width="80"
                                                         class="img-thumbnail">
                                                 @else
                                    ...
                                    <hr> 
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                     <p>{{$award->createdBy?->name}} ({{$award->created_at->format('Y-m-d')}})</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                     <p>{{$award->updatedBy?->name}} ({{$award->updated_at->format('Y-m-d')}})</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                {{-- //Edit award Modal Details --}}
                @foreach ($data['awards'] as $award)
                <div class="modal fade" id="edit-{{ $award->id }}" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body"> 
                                <form action="{{ route($base_route.'update',$award->id) }}" method="POST" class="row g-3 main_form" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <input type="hidden" name="type" value="post"> 
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="title" class="form-control title" value="{{isset($award) ? $award->title : ''}}" id="floatingName" placeholder="Album Name">
                                            <label for="floatingName">Title</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title" class="form-control title" value="{{isset($award) ? $award->sub_title : ''}}" id="floatingName" placeholder="Album Name">
                                        ...
                                        <label for="" class="form-label">Image</label>
                                            <div class="form-group">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <img src="{{asset('storage/'.$award->image)}}" width="50" class="img-thumbnail">  
                                                    @else
                                                    <input name="image" class="form-control p-4" type="file"><span class="p-2"></span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="rank" class="form-control title" value="{{isset($award) ? $award->rank : ''}}" id="floatingName" placeholder="Album Name">
                                            <label for="floatingName">Rank</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <textarea name="description" class="form-control" style="height: 100px;">{{isset($award) ? $award->description : ''}}</textarea>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                         {{isset($data['award']) ? 'Update' : 'Create' }} Page {{$panel ?? ''}}</h5>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body tabs-menu-body">
                            @if(isset($data['award']))
                            <form action="{{ route($base_route.'update',$data['award']->id) }}" method="POST" class="row g-3 main_form">
                            @csrf
                            @method('PUT') 
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1"> 
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title" value="{{ isset($data['award']) ? $data['award']->title : old('title')}}" class="form-control" id="title"
                                                placeholder="Title">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title" value="{{ isset($data['award']) ? $data['award']->sub_title : old('sub_title')}}" class="form-control"   
                                    ...
                                    <div class="col-md-12 mb-3 image">
                                        ...
                                        <div class="form-group">                     
                                            <div class="image dropify-wrapper">
                                                @if(!empty($data['award']->image))
                                                    <img src="{{ asset('storage/' . $data['award']->image) }}" alt=""
                                                        class="previewImage">
                                                @else
                                ...
                                <div class="tab-pane mb-3" id="tab2">
                                           ...
                                           <textarea name="description" class="form-control"  id="summernote" style="height: 290px;">{{isset($data['award']) ? $data['award']->description : old('description')}}</textarea>
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title" value="{{ isset($data['award']) ? $data['award']->seo_title : ''}}" class="form-control" id="floatingName"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword" value="{{ isset($data['award']) ? $data['award']->seo_keyword : ''}}" class="form-control"   
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <textarea  name="seo_description" value="" class="form-control"   
                                                placeholder="Seo Description">{{ isset($data['award']) ? $data['award']->seo_description : ''}}</textarea>
