                                    ...
                                    <td class="d-sm-flex align-items-center py-3">
                                        ...
                                        data-bs-target="#edit-{{ $download->id }}"><i
                                            ...
                                            <div class="main-toggle-group d-sm-flex align-items-center"> 
                                                <div class="toggle show_hide toggle-md toggle-{{ $download->status == '0' ? 'success' : ''}} my-1 {{ $download->status == '0' ? 'on' : 'off' }}" data-id="{{$download->id}}">
                                                     <span></span>
                                                </div>
                                            </div>
                                                ...
                                                <form action="{{ route($base_route . 'destroy', $download->id) }}"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                            <a href="#" ><i class="fa fa-trash fs-17 px-3 text-danger delete-confirm" data-id="{{$download->id}}"></i></a>
                                                </form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                     <p>{{$download->createdBy?->name}} ({{$download->created_at->format('Y-m-d')}})</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                     <p>{{$download->updatedBy?->name}} ({{$download->updated_at->format('Y-m-d')}})</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal fade" id="edit-{{ $download->id }}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body"> 
                                <form action="{{ route($base_route.'update',$download->id) }}" method="POST" class="row g-3 main_form" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <input type="hidden" name="type" value="post"> 
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="title" class="form-control title" value="{{isset($download) ? $download->title : ''}}" id="floatingName" placeholder="Name">
                                            <label for="floatingName">Title</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title" class="form-control title" value="{{isset($download) ? $download->sub_title : ''}}" id="floatingName" placeholder="Subtitle">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">File</label>
                                                ...
                                                <input name="image" class="form-control" type="file"><span class="p-2"></span> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="rank" class="form-control title" value="{{isset($download) ? $download->rank : ''}}" id="floatingName" placeholder="Rank">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                         {{isset($data['download']) ? 'Update' : 'Create' }} Page {{$panel ?? ''}}</h5>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body tabs-menu-body">
                            ...
                            <form action="{{ route($base_route.'update',$data['download']->id) }}" method="POST" class="row g-3 main_form">
                            @csrf
                            @method('PUT') 
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab1"> 
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title" value="{{ isset($data['download']) ? $data['download']->title : old('title')}}" class="form-control" id="title"
                                                placeholder="Title">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title" value="{{ isset($data['download']) ? $data['download']->sub_title : old('sub_title')}}" class="form-control"   
                                        ...
                                        <div class="form-group">                     
                                            <div class="image dropify-wrapper">
                                                @if(!empty($data['download']->image))
                                                    <img src="{{ asset('storage/' . $data['download']->image) }}" alt=""
                                                        class="previewImage">
                                                @else
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_title" value="{{ isset($data['download']) ? $data['download']->seo_title : ''}}" class="form-control" id="floatingName"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="seo_keyword" value="{{ isset($data['download']) ? $data['download']->seo_keyword : ''}}" class="form-control"   
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <textarea  name="seo_description" value="" class="form-control"   
                                                placeholder="Seo Description">{{ isset($data['download']) ? $data['download']->seo_description : ''}}</textarea>
				...
				<div class="modal-content">
					...
					<div class="modal-body"> 
                            <form action="{{ route($base_route.'store') }}" method="POST" class="row g-3 main_form" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" name="title" class="form-control title" value="" id="floatingName" placeholder="Download Name">
                                        <label for="floatingName">Title</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" name="rank" class="form-control rank" value="" id="floatingName" placeholder="Download Name">
                                        <label for="floatingName">Rank</label>
                                    </div>
                                </div>
