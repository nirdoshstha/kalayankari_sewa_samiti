    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{route('dashboard.index')}}">
                ...
                @if(setting())
                <img src="{{asset('storage/'.setting()->logo)}}" class="header-brand-img light-logo1" alt="logo">
                @endif
            </a><!-- LOGO -->
        </div>
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                 ...
                 <li class="slide @if(\Route::is('slider.index*','award.index*','team.index*','notice.index*','testimonial.index*')) is-expanded @endif">
                    <a class="side-menu__item @if(\Route::is('slider.index*','award.index*','team.index*','notice.index*','testimonial.index*')) active @endif" data-bs-toggle="slide" href="#" >
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('slider.index')}}" class="slide-item @if(\Route::is('slider.index*')) active @endif"><i class="fa fa-file-image-o fs-6  mx-2"></i>Slider</a></li>
                        <li><a href="{{route('award.index')}}" class="slide-item @if(\Route::is('award.index*')) active @endif"><i class="fa fa-trophy fs-6  mx-2"></i>School Award</a></li> 
                        <li><a href="{{route('team.index')}}" class="slide-item @if(\Route::is('team.index*')) active @endif"><i class="fa fa-group fs-6  mx-2"></i>Team Member</a></li>
                        <li><a href="{{route('notice.index')}}" class="slide-item @if(\Route::is('notice.index*')) active @endif"><i class="fa fa-list-alt fs-6  mx-2"></i>Notice</a></li> 
                        <li><a href="{{route('testimonial.index')}}" class="slide-item  @if(\Route::is('testimonial.index*')) active @endif"><i class="fa fa-file-video-o fs-6  mx-2"></i>Testimonial</a></li>                   
                    </ul>
                </li>
                 ...
                 <li class="slide @if(\Route::is('class-information.index*')) is-expanded @endif">
                    <a class="side-menu__item @if(\Route::is('class-information.index*')) active @endif" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu @if(\Route::is('class-information.index*')) active @endif">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Utilities</a></li>
                        <li><a href="{{route('class-information.index')}}" class="slide-item @if(\Route::is('class-information.index*')) active @endif"><i class="fa fa-list-alt fs-6  mx-2"></i>Class Information</a></li> 
                ...
                <li class="slide @if(\Route::is('album.index*','video.index*')) is-expanded @endif">
                    <a class="side-menu__item @if(\Route::is('album.index*','video.index*')) active @endif" data-bs-toggle="slide" href="#">
                        <i class="fa fa-file-image-o fs-6"></i>
                    ...
                    <ul class="slide-menu @if(\Route::is('album.index*','video.index*')) active @endif">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Utilities</a></li>
                        <li><a href="{{route('album.index')}}" class="slide-item @if(\Route::is('album.index*')) active @endif"><i class="fa fa-file-image-o fs-6  mx-2"></i>Album</a></li>
                        <li><a href="{{route('video.index')}}" class="slide-item @if(\Route::is('video.index*')) active @endif"><i class="fa fa-file-video-o fs-6  mx-2"></i>Video</a></li>
