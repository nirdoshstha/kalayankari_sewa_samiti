                                    ...
                                    <tr>
                                        ...
                                        <td class="d-sm-flex align-items-center py-4">
                                            ...
                                            <div class="main-toggle-group d-sm-flex align-items-center">
                                                <div class="toggle show_hide toggle-md toggle-{{ $slider->status == '0' ? 'success' : '' }} my-1 {{ $slider->status == '0' ? 'on' : 'off' }}"
                                                    data-id="{{ $slider->id }}">
                                                    <span></span>
                                                </div>
                                            </div>
                                            ...
                                            <form action="{{ route($base_route . 'destroy', $slider->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-8">
                                                    <p>{{ $slider->updatedBy?->name }}
                                                        ({{ $slider->updated_at->format('Y-m-d') }})</p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal fade" id="edit-{{ $slider->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route($base_route . 'update', $slider->id) }}" method="POST"
                                        ...
                                        {{-- <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" name="link" class="form-control title"
                                                    value="{{ isset($slider) ? $slider->slider_link : '' }}"
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">
                        ...
                        @endif
                        {{ isset($data['slider']) ? 'Update' : 'Create' }} Page {{ $panel ?? '' }}
                    </h5>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="title"
                                                value="{{ isset($data['slider']) ? $data['slider']->title : old('title') }}"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-floating">
                                            <input type="text" name="sub_title"
                                                value="{{ isset($data['slider']) ? $data['slider']->sub_title : old('sub_title') }}"
                                        ...
                                        <div class="form-group">
                                            <div class="image dropify-wrapper">
                                                @if (!empty($data['slider']->image))
                                                    <img src="{{ asset('storage/' . $data['slider']->image) }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route($base_route . 'store') }}" method="POST" class="row g-3 main_form"
                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="link" class="form-control title" value=""
                                        id="floatingName" placeholder="Album Name">
                                    <label for="floatingName">Link</label>
                                </div>
                            </div> --}}
