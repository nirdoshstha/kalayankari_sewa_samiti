						...
						<div class="wrap-login100 p-0">
							<div class="card-body">
									...
									<div class="wrap-input100 validate-input" data-bs-validate = "Valid email is required: ex@abc.xyz">
										<input type="text" name="username" id="email" class="input100 @error('email') is-invalid @enderror" placeholder="Email/Username" autocomplete="email" autofocus>
                                        @error('email')
									...
									<div class="wrap-input100 validate-input" data-bs-validate = "Password is required"> 
										<input type="password" name="password" class="input100 @error('password') is-invalid @enderror" placeholder="Password"  autocomplete="current-password">
										<span class="focus-input100"></span>
										<span class="symbol-input100">
