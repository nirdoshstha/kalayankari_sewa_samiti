                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-7 col-12 mb-4">
                        <div class="single-blog-wrapper p-3">
                            ...
                            <span class="date"><i class="fa-solid fa-calendar-days mx-2"></i> Published on : {{$data['blog_single']->created_at->format('Y-m-d H:i:s')}}</span>
                            <div class="blog-img my-4">
                                <img src="{{asset('storage/'.$data['blog_single']->image)}}" width="100%" height="100%" alt="">
                            </div>
                            <div class="blog-desc">
                                    ...
                                    <li>
                                        <a href="{{$blog->slug}}">
                                            <div class="blog-item">
                                                ...
                                                <div class="blog-desc">
                                                    <h5>{{($blog->title)}}</h5>
                                                    <span class="date"><i class="fa-solid fa-calendar-days me-2"></i>{{$blog->created_at->format('Y-m-d H:i:s')}}</span>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
