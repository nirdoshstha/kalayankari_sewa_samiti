                ...
                <div class="container">
                    <div class="row align-items-end g-4 g-md-5">
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="about-img">
                                <img src="{{ asset('storage/' . $data['introduction']?->parentId?->image) }}" width="100%"
                                    height="100%" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-8 ">
                            <div class="about-desc">
                                ...
                                <a href="{{ route('frontend.our_services', $data['introduction']->slug) }}"
                                    class="btn-read">
                                    Read More
                                </a>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="news-section mb-3">
                            <div class="title-wrapper d-flex align-items-center justify-content-between mb-3">
                                ...
                                <a href="{{ route('frontend.notices') }}">View All <i
                            ...
                            <div class="news-card-list d-flex flex-column">
                                <ul>
                                    @forelse (notices() as $notice)
                                        <li>
                                            <a href="#" class="notice_view" data-id="{{ $notice->id }}"
                                            ...
                                            <li>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#noticeModal">
                                                    <div
                                                        class="news-card d-flex align-items-start flex-column flex-lg-row align-items-lg-center">
                                                        <div class="news-img mb-3 mb-lg-0">
                                                            <img src="{{ asset('frontend/assets/image/news2.png') }}"
                                                                width="100%" height="100%" alt="">
                                                        </div>
                                                        <div class="news-desc d-flex flex-column">
                    ...
                    <div class="col-md-6">
                        <div class="blog-section mb-3">
                            <div class="title-wrapper d-flex align-items-center justify-content-between mb-3">
                                ...
                                <a href="{{ route('frontend.video') }}" target="_blank">View All <i
                                        class="fa-solid fa-angles-right"></i></a>
                            </div>
